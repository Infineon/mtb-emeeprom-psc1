/******************************************************************************
* File Name:   psc1_e_eeprom.h
*
* Description: Header file for emulated EEPROM implementation in PSOC&trade; C1 MCUs.
...
#ifndef E_EEPROM_PSC1_H
#define E_EEPROM_PSC1_H
...
* PSOC&trade; C1 internal flash memory. The Em_EEPROM middleware operates on the top
* of the flash driver included in the PSC1M3 Peripheral Driver Library.
*
...
********************************************************************************
*
* The PSOC&trade; C1 emulated EEPROM support is provided with the APIs described
* below.
*
* It should be noted that the non-volatile memory required to store the EEPROM
* Data is mapped to Internal Flash. In the PSOC&trade; C1 emulated EEPROM Middleware
...
* macro: E_EEPROM_PSC1_FLASH_TOTAL_SIZE an internal usage macro defined in code.
...
*
* For the Kit/PSC device you are using, please select the proper Linker script.
...
* and edit it for the Project using PSOC&trade; C1 Emulated EEPROM.
...
* macro: E_EEPROM_PSC1_FLASH_TOTAL_SIZE for given EEPROM size and make
* appropriate changes..
*
*
* Example of GCC_ARM Linker script for PSOC&trade; C1 Kit/Device (PSC1M-0200.ld):
*
...
*
*
* Example of ARM Linker script for PSOC&trade; C1 Kit/Device (PSC1M-0200.sct):
*
...
*
*
* Example of IAR Linker script for PSOC&trade; C1 Kit/Device (PSC1M-0200.icf):
*
* Original Linker Memory map:
*
* \code
...
*
* 
* The PSOC&trade; C1 Emulated EEPROM asset can be used to store non-volatile data in Flash
* with improved resiliency. In PSOC&trade; C1 emulated eeprom is stored in Flash at the very
* end. When compiling the PSOC&trade; C1 eeprom asset the macro: E_EEPROM_PSC1_FLASH_EEPROM_SIZE
...
* DEFINE+=E_EEPROM_PSC1_FLASH_EEPROM_SIZE="desired size".
* Note - the size of EEPROM should be larger than the sum of All the blocks that are
* configured in the PSOC&trade; C1 EEPROM configuration structure. This will allow multiple
...
* 
* The PSOC&trade; C1 EEPROM has a complex configuration and handle data structure which passes
* in the initial configuration information and it also stores the run-time data
* needed for subsequent API execution. The PSOC&trade; C1 Configuration data structure is:
* 
* Data structure to configure the APP properties. Use @ref E_EEPROM_PSC1_t type
* for accessing the members *
* typedef struct E_EEPROM_PSC1
* {
*   E_EEPROM_PSC1_BLOCK_t *block_config_ptr; // **< Pointer to user block configurations *
* 
*   E_EEPROM_PSC1_DATA_t *data_ptr; // **< Pointer to the state variable data structure *
* 
...
*   \#endif
* 
*   E_EEPROM_PSC1_STATUS_t  state; // **< Current state of the APP instance*
* 
...
* (E_EEPROM_PSC1_FLASH_EEPROM_SIZE) provided by Personality/Define via Makefile
...
* Note PSOC&trade; C1 API support read/write only on block basis.
* 
...
* 
*
* Typical EEPROM asset API sequence can be: E_EEPROM_PSC1_Init(&E_EEPROM_PSC1_handle);
* and then read/write APIs:
* E_EEPROM_PSC1_Write(blockNum, data_wbuffer);
* E_EEPROM_PSC1_Read(blockNum, 0U, data_rbuffer, block_size);
* 
* 
* 
********************************************************************************
*
*
* \defgroup E_EEPROM_PSC1_enumerations Enumerations
* \brief
* This section describes the Emulated EEPROM Macros.
*
* \defgroup E_EEPROM_PSC1_datastructures Data Structures
* \brief
* This section describes the data structures defined by the Emulated EEPROM.
*
* \defgroup E_EEPROM_PSC1_functions Functions
* \brief
...
#ifndef E_EEPROM_PSC1_FLASH_EEPROM_SIZE
#if CY_DEVICE_FAMILY == CY_FAMILY_PSC1       /* Need EEPROM Size for PSC1 - No defaults */
#error "Need to define E_EEPROM_PSC1_FLASH_EEPROM_SIZE using Personality or Makefile define"
#else /* CY_DEVICE_FAMILY == CY_FAMILY_PSC1 */
#define E_EEPROM_PSC1_FLASH_EEPROM_SIZE  (500)
#endif /* CY_DEVICE_FAMILY == CY_FAMILY_PSC1 */
#endif

#if ((E_EEPROM_PSC1_FLASH_EEPROM_SIZE < 256) || (E_EEPROM_PSC1_FLASH_EEPROM_SIZE > 50944))
#error "EEPROM SIZE IS INCORRECT. It should be between 256 and 50944"
#endif

#define E_EEPROM_PSC1_FLASH_BANK_SIZE      (((((E_EEPROM_PSC1_FLASH_EEPROM_SIZE - 1) \
                                           / CY_FLASH_BYTES_PER_PAGE) + 1) \
                                           * CY_FLASH_BYTES_PER_PAGE) + CY_FLASH_BYTES_PER_PAGE)

#define E_EEPROM_PSC1_FLASH_TOTAL_SIZE     (E_EEPROM_PSC1_FLASH_BANK_SIZE * 2)

#define E_EEPROM_PSC1_FLASH_BANK1_END      (CY_FLASH_BASE + ((CY_DEVICE_FLASH_SIZE * 1024UL) - 1))
#define E_EEPROM_PSC1_FLASH_BANK1_BASE     (E_EEPROM_PSC1_FLASH_BANK1_END - E_EEPROM_PSC1_FLASH_BANK_SIZE + 1)
#define E_EEPROM_PSC1_FLASH_BANK0_END      (E_EEPROM_PSC1_FLASH_BANK1_BASE - 1)
#define E_EEPROM_PSC1_FLASH_BANK0_BASE     (E_EEPROM_PSC1_FLASH_BANK0_END - E_EEPROM_PSC1_FLASH_BANK_SIZE + 1)

/*
 *  Total number of pages per bank, resulting after division of banks
 *  i.e. E_EEPROM_PSC1_BANK_PAGES = (E_EEPROM_PSC1_FLASH_TOTAL_SIZE in Bytes / ((256 Bytes * 2 Banks))
 */
#define E_EEPROM_PSC1_BANK_PAGES           (E_EEPROM_PSC1_FLASH_TOTAL_SIZE / (CY_FLASH_BYTES_PER_PAGE * 2))

#if (E_EEPROM_PSC1_FLASH_TOTAL_SIZE > (((CY_DEVICE_FLASH_SIZE * 1024UL) / 2UL) - 1024UL))
 ...
 * MACROS
 ****************************************************************************/
#define E_EEPROM_PSC1_PSC1M3_LIB_MAJOR_VERSION 1
#define E_EEPROM_PSC1_PSC1M3_LIB_MINOR_VERSION 0
#define E_EEPROM_PSC1_PSC1M3_LIB_PATCH_VERSION 0

#if !((CY_PSC1M3_LIB_MAJOR_VERSION > E_EEPROM_PSC1_PSC1M3_LIB_MAJOR_VERSION) ||\
      ((CY_PSC1M3_LIB_MAJOR_VERSION == E_EEPROM_PSC1_PSC1M3_LIB_MAJOR_VERSION) && (CY_PSC1M3_LIB_MINOR_VERSION > E_EEPROM_PSC1_PSC1M3_LIB_MINOR_VERSION)) ||\
      ((CY_PSC1M3_LIB_MAJOR_VERSION == E_EEPROM_PSC1_PSC1M3_LIB_MAJOR_VERSION) && (CY_PSC1M3_LIB_MINOR_VERSION == E_EEPROM_PSC1_PSC1M3_LIB_MINOR_VERSION) && (CY_PSC1M3_LIB_PATCH_VERSION >= E_EEPROM_PSC1_PSC1M3_LIB_PATCH_VERSION)))
#error "E_EEPROM_PSC1 requires PSC1M3 Peripheral Library v1.0.0 or higher"
#endif

/** Physical flash Block size and Page size defined*/
#define E_EEPROM_PSC1_FLASH_BLOCK_SIZE  (16U)
#define E_EEPROM_PSC1_FLASH_PAGE_SIZE   (256U)
...
uint32_t e_eeprom_psc1_test_hook_readblock;
uint32_t e_eeprom_psc1_test_hook_writeblock;
uint32_t e_eeprom_psc1_test_hook_writepage;
uint32_t e_eeprom_psc1_test_hook_erasepage;
uint32_t e_eeprom_psc1_test_hook_readword;
uint32_t e_eeprom_psc1_test_hook_getflashstatus;
#endif
...
/**
* \addtogroup E_EEPROM_PSC1_enumerations
* \{
*/

/** Defines the error codes for E_EEPROM_PSC1 APP. */
typedef enum E_EEPROM_PSC1_STATUS
{
  E_EEPROM_PSC1_STATUS_SUCCESS        = 0U, /**< Successful completion of APP initialization */
  E_EEPROM_PSC1_STATUS_FAILURE        = 1U, /**< Initialization failed due to internal operational error*/
  E_EEPROM_PSC1_STATUS_UNINITIALIZED  = 2U, /**< APP is in Uninitialized state*/
  E_EEPROM_PSC1_STATUS_IDLE           = 3U, /**< APP is in IDLE state. Only used in E_EEPROM_PSC1_GetStatus() API */
  E_EEPROM_PSC1_STATUS_BUSY           = 4U  /**< APP is in BUSY state. Only used in E_EEPROM_PSC1_GetStatus() API */
} E_EEPROM_PSC1_STATUS_t;

/**
 * Defines current status for E_EEPROM_PSC1 APP.
 */

typedef enum E_EEPROM_PSC1_OPERATION_STATUS
{
  E_EEPROM_PSC1_OPERATION_STATUS_SUCCESS            = 0U, /**< Successful completion of operation*/
  E_EEPROM_PSC1_OPERATION_STATUS_FAILURE            = 1U, /**< APP failed due to internal flash operational errors*/
  E_EEPROM_PSC1_OPERATION_STATUS_INCONSISTENT_BLOCK = 2U, /**< Targeted block is inconsistent*/
  E_EEPROM_PSC1_OPERATION_STATUS_INVALID_BLOCK      = 3U, /**< The latest copy of the targeted block was invalidated */
  E_EEPROM_PSC1_OPERATION_STATUS_CRC_FAILED         = 4U, /**< CRC verification failed for the targeted block*/
  E_EEPROM_PSC1_OPERATION_STATUS_NOT_ALLOWED        = 5U, /**< Operation not allowed to continue*/
  E_EEPROM_PSC1_OPERATION_STATUS_MEMORY_BANK_FULL   = 6U, /**< Write/Invalidate operation failed when bank has no space.
                                                             Call E_EEPROM_PSC1_StartGarbageCollection API to proceed */
  E_EEPROM_PSC1_OPERATION_STATUS_NO_CRC_WRITTEN     = 7U  /**< Written block does not have CRC checksum enabled.*/
...
/**
* \addtogroup E_EEPROM_PSC1_datastructures
* \{
*/
/*****************************************************************************
 * * DATA STRUCTURES
...
} E_EEPROM_PSC1_CACHE_STATUS_t;
/*lint -e46 */


/** Data structure to hold the information about the physical address and status of a user data block */
typedef struct E_EEPROM_PSC1_CACHE
{
  uint32_t address; /**< It has the actual physical address of the flash where the written data block starts */

  E_EEPROM_PSC1_CACHE_STATUS_t status; /**< Status information of the written user data block (Valid/Consistent/CRC)*/

} E_EEPROM_PSC1_CACHE_t;


/** Data structure to hold the count of flash physical blocks and status of a user data block */
typedef struct E_EEPROM_PSC1_TRAVERSE_BLOCK_RESULT
{
  uint32_t block_count; /**< Number of physical flash blocks required for a particular data block */

  E_EEPROM_PSC1_CACHE_STATUS_t status; /**< status of the user data block */

} E_EEPROM_PSC1_TRAVERSE_BLOCK_RESULT_t;


/** Data structure to hold the complete state data information of Emulation APP (Run Time Handler)*/
typedef struct E_EEPROM_PSC1_DATA
{
  E_EEPROM_PSC1_CACHE_t *block_info;/**< User data block information */

  E_EEPROM_PSC1_TRAVERSE_BLOCK_RESULT_t block_result; /**< get previous data block read result information */
  ...
  uint8_t   read_write_buffer[E_EEPROM_PSC1_FLASH_BLOCK_SIZE]; /**< Internal buffer to load and store single block */

  uint32_t  crc_buffer; /**< Keeps track the CRC 16 bit CRC value */

  uint8_t   page_write_buffer[E_EEPROM_PSC1_FLASH_PAGE_SIZE]; /**< Internal buffer to load and store single page */
...
} E_EEPROM_PSC1_DATA_t;


/** Data structure to configure the APP properties. Use @ref E_EEPROM_PSC1_t type for accessing the members */
typedef struct E_EEPROM_PSC1
{
  E_EEPROM_PSC1_BLOCK_t *block_config_ptr; /**< Pointer to user block configurations */
...
typedef E_EEPROM_PSC1_t* E_EEPROM_PSC1_HANDLE_PTR_t; /**< Defines a pointer to APP Handle*/
...
/**
* \addtogroup E_EEPROM_PSC1_functions
* \{
*/

/**
 * @brief Initializes E_EEPROM_PSC1 APP with the associated configuration handle.
 * @param handle_ptr : Pointer to the handler of the instance for which this API is called<BR>
 *
 * @return<BR> E_EEPROM_PSC1_STATUS_SUCCESS if initialization is successful else E_EEPROM_PSC1_STATUS_FAILURE<BR>
 *
 ...
 *      banks are erased by calling the cy_flash low level driver API's.\n\n
 ...
 * </OL>
 * <b>IMPORTANT : </b> This API must be successfully called before calling any other E_EEPROM_PSC1 API.<BR>
 *
 */
 ...
 *                @ref E_EEPROM_PSC1_BLOCK_t configuration structure array.
 * @param data_buffer_ptr : Pointer to the user data buffer which need to be stored in flash
 *
 * @return <BR>
 *    E_EEPROM_PSC1_OPERATION_STATUS_SUCCESS, if the write operation is successful<BR>
 *    E_EEPROM_PSC1_OPERATION_STATUS_NOT_ALLOWED, if APP initialization is not completed or flash is busy<BR>
 *    E_EEPROM_PSC1_OPERATION_STATUS_MEMORY_BANK_FULL, if no space available in flash bank to write the block<BR>
 *    E_EEPROM_PSC1_OPERATION_STATUS_FAILURE, if write failed due to internal flash errors<BR>
 *
 * \par<b>Description:</b><br>
 ...
 *<b>IMPORTANT : </b> This API shall be called only after the successful completion of E_EEPROM_PSC1_Init() API.<BR>
 ...
 *            E_EEPROM_PSC1_GetStatus() API and verifying the status.\n\n
 *
 ...
 *
 * @return <BR>
 *     E_EEPROM_PSC1_OPERATION_STATUS_SUCCESS, if read operation from flash is successful<BR>
 *     E_EEPROM_PSC1_OPERATION_STATUS_FAILURE, if read failed due to ECC errors<BR>
 *     E_EEPROM_PSC1_OPERATION_STATUS_NOT_ALLOWED, if APP initialization is not completed or flash is busy<BR>
 *     E_EEPROM_PSC1_OPERATION_STATUS_INCONSISTENT_BLOCK, if the targeted block was not written properly<BR>
 *     E_EEPROM_PSC1_OPERATION_STATUS_INVALID_BLOCK, if the targeted block was invalidated<BR>
 *
 * \par<b>Description:</b><br>
 ...
 * @param :
 * @return <BR>
 *     E_EEPROM_PSC1_OPERATION_STATUS_SUCCESS, if garbage collection is successful<BR>
 *     Else return E_EEPROM_PSC1_OPERATION_STATUS_FAILURE on internal flash errors<BR>
 *
 * \par<b>Description:</b><br>
 *  Performs an explicit Garbage collection any time during the execution of APP. The function is
 *  accepted only if the E_EEPROM_PSC1 is in IDLE state.
 *
 ...
 *    E_EEPROM_PSC1_OPERATION_STATUS_NOT_ALLOWED, if APP initialization is not completed or flash is busy<BR>
 *    E_EEPROM_PSC1_OPERATION_STATUS_MEMORY_BANK_FULL, if no space available in flash bank to write the block<BR>
 *    E_EEPROM_PSC1_OPERATION_STATUS_FAILURE, else failed due to internal flash errors<BR>
 *
 * \par<b>Description:</b><br>
 ...
 *
 * @return <BR>
 *        E_EEPROM_PSC1_STATUS_IDLE, if APP is in IDLE state to accept any request<BR>
 *        E_EEPROM_PSC1_STATUS_FAILURE, if any previous operation on APP failed due to some internal error<BR>
 *        E_EEPROM_PSC1_STATUS_BUSY, Else APP is in busy state because of flash operations<BR>
 *
 * \par<b>Description:</b><br>
 ...
 *            E_EEPROM_PSC1_StartGarbageCollection().
 *
 */
 ...
 *     E_EEPROM_PSC1_OPERATION_STATUS_INCONSISTENT_BLOCK, if the targeted block was not written properly<BR>
 *     E_EEPROM_PSC1_OPERATION_STATUS_INVALID_BLOCK, if the targeted block was invalidated<BR>
 *     E_EEPROM_PSC1_OPERATION_STATUS_NO_CRC_WRITTEN, if the targeted block was written before without CRC enabled<BR>
 *     E_EEPROM_PSC1_OPERATION_STATUS_CRC_FAILED, else CRC verification failed for the targeted block<BR>
 *
 * \par<b>Description:</b><br>
